...
function Contact() {
  return (
    <div className="w-[70%] ml-auto mr-auto mb-15 ">
      ...
      <div className="shadow-2xl h-60 bg-white border border-slate-200 grid grid-cols-6 gap-2 rounded-xl p-2 text-sm">
        <h1 className="text-center text-blue-600 text-xl font-bold col-span-6">
          Send Feedback
        </h1>
        <textarea
          placeholder="Your feedback..."
          className="bg-slate-100 text-slate-600 h-28 placeholder:text-slate-600 placeholder:opacity-50 border border-slate-200 col-span-6 resize-none outline-none rounded-lg p-10 duration-300 focus:border-slate-600"
        ></textarea>
